...
const translations = {
    'zh-CN': {
        ...
        'config.advanced.codexPotluckStickyTitle': 'API Potluck Codex 固定账号',
        'config.advanced.codexPotluckStickyNote': '开启后，同一个 API Potluck 分发 Key 的 Codex 请求会尽量走同一个健康 Codex 账号，提高 prompt cache 复用率；账号不可用时自动切换。',
        'config.advanced.codexPotluckStickyEnabled': '启用固定账号',
    ...
    'en-US': {
        ...
        'config.advanced.codexPotluckStickyTitle': 'API Potluck Codex Sticky Account',
        'config.advanced.codexPotluckStickyNote': 'When enabled, Codex requests from the same API Potluck key will prefer the same healthy Codex account to improve prompt cache reuse, with automatic fallback when unavailable.',
        'config.advanced.codexPotluckStickyEnabled': 'Enable Sticky Account',
