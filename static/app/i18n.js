...
const translations = {
    'zh-CN': {
        ...
        'usage.card.tokenTelemetry': 'Token 使用统计',
        'usage.card.dataAsOf': '数据截至 {date}',
        'usage.card.dataDelayed': '数据延迟',
        'usage.card.updatedAt': '更新于 {time}（北京时间）',
        'usage.card.updatedAtMismatch': '更新时间异常：{time}（北京时间）',
    ...
    'en-US': {
        ...
        'usage.card.tokenTelemetry': 'Token Usage Statistics',
        'usage.card.dataAsOf': 'Data as of {date}',
        'usage.card.dataDelayed': 'Data delayed',
        'usage.card.updatedAt': 'Updated {time} (Beijing time)',
        'usage.card.updatedAtMismatch': 'Update time differs: {time} (Beijing time)',
